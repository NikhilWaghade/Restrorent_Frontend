      ...
      <section className="bg-gray-200">
       ...
       <section className="relative py-16 px-6 md:px-20 w-full h-96">
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          <h2 className="text-5xl font-bold mb-6 text-white">About</h2>
          <p className="text-lg font-bold text-white">Swaad Nation serves authentic, flavorful meals made daily with fresh, organic ingredients. We combine traditional recipes and modern cooking to deliver wholesome dishes that warm the heart and satisfy every craving. Experience the true taste of home with us.</p>
        </div>
      </section>

        {/* Description Section about Swaad Nation */}
        <section className="max-w-4xl mx-auto px-6 md:px-20 py-12 bg-white rounded-lg shadow-lg mt-10">
          <h3 className="text-3xl font-semibold text-red-600 mb-4 text-center">
          ...
          <section className="mt-16 px-6 md:px-20">
            ...
            <div className="grid gap-8 md:grid-cols-2">
              {news.map((item, idx) => (
                <div
                  key={idx}
                  className="group bg-white rounded-lg shadow-md hover:shadow-xl overflow-hidden transition"
                >
